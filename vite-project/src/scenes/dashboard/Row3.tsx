...
const Row3 = (props: Props) => {
  ...
  return (
    <>
      <DashboardBox bgcolor="#ffff" gridArea="g">
        <BoxHeader
      ...
      <DashboardBox bgcolor="#ffff" gridArea="h">
        {" "}
        <BoxHeader
          title="List of Products"
      ...
      <DashboardBox bgcolor="#ffff" gridArea="i">
      ...
      <DashboardBox bgcolor="#ffff" gridArea="j">
        <BoxHeader
